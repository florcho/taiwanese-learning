...
const LESSONS = [
  ...
  {
    "id": "L29",
    "title": "브랜드→인플루언서 협업 제안 DM",
    "subtitle": "限動/檔期/授權/加工 — 업계 핵심 4어휘 + 제안 문체",
    "source": "Auto-corpus 2026-06-10",
    "type": "business_email_terms",
    "difficulty": "B1-B2",
    "date": "2026-06-10",
    "fullText": "感謝您的熱情回覆！🙏\n您提到7月會前往首爾並有興趣透過旅遊影片介紹我們的App，\n這個概念真的很棒💡\n協業方案如下：\n✅ 合作形式：IG Reels (90秒以內) + 1則 IG 限動(帶連結)\n✅ 合作檔期：7月底以前(避開假日上刊)\n✅ 廣告授權＋2次加工 (可選)\n因為合作細節較多，若要進一步討論詳細內容，\n建議透過官方LINE聯繫會更方便～\n期待收到您的聯絡！🧡",
    "koreanSummary": "브랜드가 인플루언서에게 보내는 협업 제안 DM. 7월 서울 방문 콘텐츠로 앱을 소개해달라는 제안이며, 형식(Reels+스토리), 일정(7월 말 이전, 휴일 제외 게재), 광고 권한+2차 가공 조건을 명시하고 LINE으로 상세 논의를 유도한다.",
    "sentences": [
        {
            "id": 1,
            "hanzi": "感謝您的熱情回覆！",
    ...
    "vocab": [
        {
            ...
            "example": {
                "hanzi": "請在限動加上我們的官方帳號標籤。",
                "korean": "스토리에 저희 공식 계정 태그를 달아주세요."
            }
        },
        {
            "hanzi": "檔期",
        ...
        },
        {
            ...
            "example": {
                "hanzi": "預計下週五上刊，請提前確認腳本。",
                "korean": "다음 주 금요일에 게재 예정이니 미리 스크립트를 확인해주세요."
            }
        },
        {
            "hanzi": "加工",
  ...
  {
    "id": "L30",
    "title": "인플루언서 DM 3종 세트 — 소재 문의·일정 거절·협업 타진",
    "subtitle": "실무 DM 핵심 패턴: 請問您有…嗎 / 檔期已排滿 / 是否能…進行合作",
    "source": "Auto-corpus 2026-06-10",
    "type": "casual_work_chat",
    "difficulty": "B1-B2",
    "date": "2026-06-10",
    "fullText": "請問您有在韓國皮膚科接受施術時拍攝的、可以用於合作的影片素材嗎？\n謝謝您的合作邀約，不過該合作檔期已排滿，祝福您找到合適的創作者！\n您好～想請問一下，是否能以7月底前發佈Reels的形式進行合作呢？",
    "koreanSummary": "①한국 피부과 시술 영상 소재 있는지 문의 → ②일정이 꽉 찼다고 정중히 거절 → ③7월 말 Reels 게시 조건으로 협업 가능한지 타진. 세 문장 모두 인플루언서·브랜드 DM에서 반복되는 실전 표현.",
    "sentences": [
        {
            "id": 1,
    ...
    "vocab": [
        ...
        },
        {
            ...
            "example": {
                "hanzi": "七月的檔期已經排滿了，八月可以嗎？",
                "korean": "7월 스케줄이 이미 꽉 찼는데, 8월은 가능한가요?"
            }
        },
        {
            "hanzi": "排滿",
            ...
            "example": {
                "hanzi": "這週的行程已排滿，下週再約吧。",
                "korean": "이번 주 일정이 이미 꽉 찼으니 다음 주에 다시 잡아요."
            }
        },
        {
            "hanzi": "以…的形式",
...
},
  {
    ...
    "difficulty": "B1",
    "date": "2026-06-11",
    "fullText": "您好，這次合作的報價我們再確認一下：圖文一篇 $8000，短影音一支 $15000，都含一次修改。若需要加購限動，每則 $3000。授權期間為三個月，到期可續約。再麻煩您確認，謝謝！",
    "koreanSummary": "안녕하세요, 이번 협업 견적을 다시 한번 확인드립니다: 이미지+글 1건 $8000, 숏폼 영상 1개 $15000, 모두 1회 수정 포함. 스토리 추가 시 건당 $3000. 사용권 기간은 3개월이며 만료 후 연장 가능합니다. 확인 부탁드립니다.",
    "sentences": [
        {
            "id": 1,
  ...
  {
    "id": "L32",
    "title": "인플루언서 견적·계약·일정 협의 메시지",
    "subtitle": "보고報價·授權·簽約·付款 — 크리에이터가 브랜드와 실제로 쓰는 문장 패턴",
    "source": "Auto-corpus 2026-06-12",
    "type": "business_email_terms",
    "difficulty": "B1-B2",
    "date": "2026-06-12",
    "fullText": "你好謝謝貴司的邀約\n2026合作方案\n• 內容形式：Instagram Reels 短影音 1 支\n• 附加贈送內容：\n  • Threads 貼文 1 則（不過稿）\n  • 2週投廣授權（全版位）\n  • Instagram 限時動態 1 則（不過稿）\n合作費用：NT$120,000（未稅）\n如有進一步需求，歡迎與我聯繫，期待合作！",
    "koreanSummary": "안녕하세요, 귀사의 제안에 감사드립니다. 2026년 협업 방안을 제안드립니다. 콘텐츠 형식은 Instagram Reels 숏폼 영상 1편이며, 추가 증정 콘텐츠로 Threads 게시물 1건(원고 검토 없음), 2주 광고 송출 권한(전 지면), Instagram 스토리 1건(원고 검토 없음)을 포함합니다. 협업 비용은 NT$120,000(부가세 별도)이며, 추가 요청사항이 있으시면 언제든 연락 주세요. 협업을 기대하겠습니다!",
    "sentences": [
        {
            "id": 1,
            "hanzi": "謝謝貴司的邀約，期待合作！",
    ...
    "vocab": [
        ...
        },
        {
            ...
            "example": {
                "hanzi": "這次合作包含 Instagram Reels 短影音 1 支。",
                "korean": "이번 협업에는 Instagram Reels 숏폼 영상 1편이 포함됩니다."
            }
        },
        {
            "hanzi": "投廣授權",
        ...
        },
        {
            ...
            "zhuyin": "ㄊㄨˊ ㄨㄣˊ",
            "pinyin": "túwén",
            "korean": "이미지+텍스트 콘텐츠 (SNS 카드뉴스·그래픽 게시물)",
            "pos": "명사",
            "hsk": "대만식",
            "tags": [
                "업계",
            ...
            "example": {
                "hanzi": "我們可以提供圖文或短影音，請問您偏好哪種形式？",
                "korean": "이미지+텍스트 콘텐츠 또는 숏폼 영상을 제공할 수 있는데, 어떤 형식을 선호하시나요?"
            }
        },
        {
            "hanzi": "貼文",
  ...
  {
    "id": "L33",
    "title": "광고 권리·독점 조항 협상 — 授權·包框再製·합작 기간 독점",
    "subtitle": "廣告主授權 vs 包框再製 차이 이해 + 독점 조항 질의 실전 표현",
    "source": "Auto-corpus 2026-06-12",
    "type": "business_email_terms",
    "difficulty": "B1-B2",
    "date": "2026-06-12",
    "fullText": "Hi～ Seas 我們有和主管確認過報價了，想跟您合作 IG Reels+Story+廣告主授權(3個月)+廣告包框再製(3個月) 但因為UNNI在台灣市場才剛起步的關係，預算上還是有些限制 QQ 不知道有沒有機會提供我們整包優惠價 USD 950呢～ 再請Seas 幫我們評估看看，希望有合作的機會，謝謝您！\n我想確認一下～我以為廣告主授權(3個月) 和廣告包框再製(3個月)是會擇一使用\n那麼兩個差別會是什麼呢～\n阿～廣告主的話就是我們會請Seas幫我們複製IG REELS的協作廣告 去投放廣告\nSeas～我有確認到信件中 >>（再製範圍僅提供最終檔案片段剪切，不可增加…）\n再製的畫室會包框投放！\n一個是原始影片投 一個是根據廣告長度編輯成6秒 15秒～\n原來如此～那麼這邊會比較希望可以進行兩者擇一進行！再麻煩您評估\n因為我想說您們這邊有提到說 如果有合作期間沒辦法潑其他相關影片所以才想說問問您\n我在接你們合作前 五月底有接了一個脆的合作 是只要在脆潑文而已～ 這樣不會有影響對嗎？\n目前還沒發 但這幾天會發 因為是您找我合作前的邀約～",
    "koreanSummary": "UNNI 브랜드 담당자가 인플루언서 Seas에게 IG Reels+Story+광고주 권한(3개월)+광고 패키지 일괄 특가 USD 950을 제안하며, 廣告主授權(브랜드가 인플루언서 계정으로 광고 집행)과 包框再製(영상을 6초·15초로 재편집해 집행)의 차이를 확인한다. 또한 협업 기간 독점 조항에 걸리는지 묻고, 계약 전에 이미 받은 Threads(脆) 협업은 영향이 없는지 질의한다.",
    "sentences": [
        {
            "id": 1,
  ...
  {
    "id": "L34",
    "title": "크리에이터 DM — 腳本 검토·업무 캐주얼 메시지",
    "subtitle": "想問說·來過·聯繫上了·沒事沒事 — 실전 업무 DM 패턴 6개",
    "source": "Auto-corpus 2026-06-12",
    "type": "casual_work_chat",
    "difficulty": "B1",
    "date": "2026-06-12",
    "fullText": "文婷~想問說腳本初稿有出來了嗎 謝謝!!\n那接下來就拜託文婷了!! 我們今天來過腳本初稿\n幫我跟他們說有聯繫上了唷\n沒事沒事\n就是體驗產品 介紹使用感受\n顧慮的地方呢",
    "koreanSummary": "원팅님께 스크립트 초안 나왔는지 여쭤보고, 같이 검토하자고 한 뒤 — 연락 닿았다고 전달 부탁, 괜찮다고 달래고, 제품 체험·사용감 소개가 핵심이라고 설명하며, 우려되는 부분이 있는지 묻는 크리에이터-브랜드 담당자 간 캐주얼 업무 DM 흐름.",
    "sentences": [
        {
            "id": 1,
    ...
    "vocab": [
        ...
        },
        {
            ...
            "example": {
                "hanzi": "初稿出來之後請先給品牌方確認。",
                "korean": "초안이 나오면 먼저 브랜드 쪽에 확인해 주세요."
            }
        },
        {
            "hanzi": "來過",
  ...
  {
    "id": "L35",
    "title": "절기·공휴일 캘린더 어휘 — 母親節檔期·國慶日·連假",
    "subtitle": "마케팅 시즌·공휴일 명칭과 실무 일정 조율 패턴",
    "source": "Auto-corpus 2026-06-13",
    "type": "vocab_burst",
    "difficulty": "A2-B1",
    "date": "2026-06-13",
    "fullText": "母親節檔期快到了，我們想在連假前完成上刊。國慶日連假期間流量通常比較高，很適合安排業配。請問您國慶日前有空檔嗎？如果可以的話，希望在連假開始前三天上刊。",
    "koreanSummary": "어머니날 시즌이 다가오고 있으니 연휴 전에 게재를 마치고 싶다는 내용. 국경일 연휴 기간에는 트래픽이 높아 PR 콘텐츠를 올리기 좋다며, 국경일 전에 빈 일정이 있는지 묻고 연휴 시작 3일 전 게재를 요청하는 실무 대화.",
    "sentences": [
        {
            "id": 1,
    ...
    "vocab": [
        ...
        },
        {
            ...
            "zhuyin": "ㄧㄝˋ ㄆㄟˋ",
            "pinyin": "yèpèi",
            "korean": "협찬 광고 콘텐츠; PR 포스팅 (業務配合의 줄임말)",
            "pos": "명사",
            "hsk": "업계",
            "tags": [
                "업무",
            ...
            "example": {
                "hanzi": "這次業配希望在國慶連假前上線。",
                "korean": "이번 PR 콘텐츠는 국경일 연휴 전에 게시되길 바랍니다."
            }
        },
        {
            "hanzi": "母親節",
  ...
  {
    "id": "L36",
    "title": "KOL 협업 거절 이메일 — 忍痛拒絕 패턴",
    "subtitle": "정중한 거절 관용구·說服力·只好 구문 실전 습득",
    "source": "Auto-corpus 2026-06-12",
    "type": "business_email_terms",
    "difficulty": "B1-B2",
    "date": "2026-06-15",
    "fullText": "謝謝邀約，我對這個合作很有興趣，但是我沒有在韓國做過醫美，這樣推薦起來似乎沒有那麼有說服力，只好忍痛拒絕，再次感謝邀約。",
    "koreanSummary": "제안해주셔서 감사해요. 이번 협업에 관심이 아주 많지만, 한국에서 의료미용을 받아본 적이 없어서 이렇게 추천하면 설득력이 부족할 것 같아요. 그래서 아쉽지만 어쩔 수 없이 거절하게 되었어요. 다시 한번 제안에 감사드려요.",
    "sentences": [
        {
            "id": 1,
